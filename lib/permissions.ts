...
export const PERMISSION_CATEGORIES = {
  ...
  hr_attendance_leave: {
    ...
    permissions: [
      ...
      { key: "hr.break.view_own", label: "View Own Break Time" },
      { key: "hr.break.view_all", label: "View All Employees' Break Time" },
      { key: "hr.break.record", label: "Start / End Break" },
      { key: "hr.break.penalize", label: "Create Break Penalties" },
      { key: "hr.break.threshold", label: "Manage Break Time Threshold" },
