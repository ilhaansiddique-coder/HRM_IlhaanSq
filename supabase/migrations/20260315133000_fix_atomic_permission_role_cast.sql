...
DECLARE
  ...
  normalized_role_enum public.user_role;
...
BEGIN
  ...
  IF normalized_role NOT IN ('tenant_admin', 'manager', 'staff', 'viewer') THEN
    RAISE EXCEPTION 'unsupported role: %', normalized_role;
  END IF;

  normalized_role_enum := normalized_role::public.user_role;
