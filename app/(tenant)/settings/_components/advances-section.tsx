...
import { AdvanceDialog } from "../../hr/payroll/advances/_components/advance-dialog";
import { EditAdvanceDialog } from "../../hr/payroll/advances/_components/edit-advance-dialog";
import {
  AdvancesTable,
  type AdvanceRow,
} from "../../hr/payroll/advances/_components/advances-table";
import { AdvanceLiveRefresh } from "../../hr/payroll/_components/advance-live-refresh";
import { cancelAdvanceAction } from "../../hr/actions-phase2";

// Employee advances management — relocated from /hr/payroll/advances into the
// Settings page (Advances tab).
export async function AdvancesSection() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* New Advance form opens from the "+" button in the top bar. */}
      <AdvanceDialog
      ...
      <div className="space-y-3">
        {advances.length === 0 ? (
          ...
          <>
            {/* Mobile / tablet: one card per advance */}
            ...
            {/* Desktop: the project-wide DataTable */}
