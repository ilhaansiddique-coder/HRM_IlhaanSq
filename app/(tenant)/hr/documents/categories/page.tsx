  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Document Categories</h1>
          <p className="text-sm text-muted-foreground">Organize documents by type (Contracts, IDs, Visas, etc.)</p>
        </div>
      </div>
